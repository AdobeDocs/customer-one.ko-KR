...
지원 관리자 역할을 할당하려면 [enterprise admin 역할 편집](admin-roles.md#add-admin-teams) 관리 역할 설명서의 지침 조직의 시스템 관리자만 이 역할을 할당할 수 있습니다. 관리 계층에 대한 자세한 내용은 [관리자 역할](admin-roles.md) 설명서.
